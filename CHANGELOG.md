...
- Based on [SQLite3 Multiple Ciphers 2.3.5](https://github.com/utelle/SQLite3MultipleCiphers/releases/tag/v2.3.5) and [SQLite 3.53.2](https://sqlite.org/releaselog/3_53_2.html)

## [2.3.4] - 2026-05-06

### Changed

- Based on [SQLite3 Multiple Ciphers 2.3.4](https://github.com/utelle/SQLite3MultipleCiphers/releases/tag/v2.3.4) and [SQLite 3.53.1](https://sqlite.org/releaselog/3_53_1.html)
...
- Based on [SQLite3 Multiple Ciphers 2.3.3](https://github.com/utelle/SQLite3MultipleCiphers/releases/tag/v2.3.3) and [SQLite 3.53.0](https://sqlite.org/releaselog/3_53_0.html)
...
- Based on [SQLite3 Multiple Ciphers 2.3.2](https://github.com/utelle/SQLite3MultipleCiphers/releases/tag/v2.3.2) and [SQLite 3.51.3](https://sqlite.org/releaselog/3_51_3.html)
...
- Based on [SQLite3 Multiple Ciphers 2.3.1](https://github.com/utelle/SQLite3MultipleCiphers/releases/tag/v2.3.1) and [SQLite 3.51.3](https://sqlite.org/releaselog/3_51_3.html)
...
- Based on [SQLite3 Multiple Ciphers 2.3.0](https://github.com/utelle/SQLite3MultipleCiphers/releases/tag/v2.3.0) and [SQLite 3.52.0](https://sqlite.org/releaselog/3_52_0.html)

## [2.2.7] - 2026-01-10

### Changed

- Based on [SQLite3 Multiple Ciphers 2.2.7](https://github.com/utelle/SQLite3MultipleCiphers/releases/tag/v2.2.7) and [SQLite 3.51.2](https://sqlite.org/releaselog/3_51_2.html)
